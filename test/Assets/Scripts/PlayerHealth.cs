...
{	
	...
	private PlayerControltest3d playerControltest3d;		// Reference to the PlayerControl script.
		...
		if(col.gameObject.tag == "Enemy")
		{
			...
			if (Time.time > lastHitTime + repeatDamagePeriod) 
			{
				...
				else
				{
					...
					GetComponent<PlayerControltest3d>().enabled = false;
	...
	void TakeDamage (Transform enemy)
	{
		...
		playerControltest3d.jump = false;
